namespace CajaRegistradora
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] cashTill = new int[] { 0, 0, 0, 0 }; //Caja registradora
        ...
        public static void LoadTillEachMorning(int[,] registerDailyStartingCash, int[] cashTill)
        {
        ...
        //En la caja registradora se guarda la cantidad de billetes que hay por cada denominación.
